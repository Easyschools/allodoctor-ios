//
//  ProfileRefundPolicyViewController.swift
//  Allo-Doctor
//
...
class ProfileRefundPolicyViewController: BaseViewController<ProfileRefundPolicyViewModel> {
    ...
    override func setupUI() {
        titleLabel.text = AppLocalizedKeys.refundPolicy.localized
    }
